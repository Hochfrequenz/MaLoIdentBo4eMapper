...
/// <summary>
/// combines the information from a negative MaLoIdent response by the Netzbetreiber request body with the query parameters and all metadata that are relevant internally
/// </summary>
public class NegativeMaLoIdentResponseAndQueryParameters
{
    /// <summary>
    ...
    /// <summary>
    /// <inheritdoc cref="MaLoIdentModels.ResultNegative"/>
    /// from the original VNB payload
    /// </summary>
    [JsonPropertyName("resultNegative")]
    public required ResultNegative ResultNegative { get; init; }
